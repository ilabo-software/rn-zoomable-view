...
declare class ReactNativeZoomableViewWithGestures extends React.Component<ReactNativeZoomableViewWithGesturesProps, ReactNativeZoomableViewState> {
     ...
     * @private
     */
    _couldCallSwipeEvent(zoomableViewState: any): false | ((gestureState: import("react-native").PanResponderGestureState) => void) | undefined;
    /**
     ...
     * @private
     */
    _getSwipeDirection(gestureState: any): string | null | undefined;
    /**
...
//# sourceMappingURL=ReactNativeZoomableViewWithGestures.d.ts.map